...
By the default the template creates a single `HelloWorld` contract under proof_of_attendance folder in the `smart_contracts` directory. To add a new contract:
